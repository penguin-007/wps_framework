...
class Users
{
    ...
    public static function initScript()
    {
        ...
        wp_enqueue_script( 'croppie',  get_stylesheet_directory_uri()  . '/custom/assets/js/croppie/croppie.min.js', array('jquery'), WPS_VERSION, true );
        wp_enqueue_style ( 'croppie',   get_stylesheet_directory_uri()  . '/custom/assets/js/croppie/croppie.css', array(), WPS_VERSION, null );

        wp_enqueue_script( 'ulogin', '//ulogin.ru/js/ulogin.js', array('jquery'), '1.0.0', true );

        wp_enqueue_script  ( 'wps_users_actions',  get_stylesheet_directory_uri()  . '/custom/users_actions.js', array('jquery'), WPS_VERSION, true );
    }
